...
#include "env_validate.h"
  ...
  #error "Zboard only supports one E Stepper. Comment out this line to continue."
#elif HAS_MULTI_HOTEND
  #error "Zboard only supports one hotend / E-stepper. Comment out this line to continue."
#endif

#define BOARD_INFO_NAME       "Zboard"
#define BOARD_WEBSITE_URL     "github.com/CN-CNC/Zboard"
